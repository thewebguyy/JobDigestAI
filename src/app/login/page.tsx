...
import { Zap, ArrowLeft, Github, Lock, Mail } from "lucide-react";
                        ...
                        <CardContent className="p-8 space-y-6">
                            <div className="space-y-4">
                                <Button
                                    ...
                                    className="w-full h-12 gap-3 font-bold uppercase tracking-widest border-primary/10 hover:bg-primary/5"
                                >
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="email"
                                        type="email"
                                        placeholder="engineer@intelligence.io"
                                        required
                                        value={email}
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        <Label htmlFor="password" title="Access Code" className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Access Code</Label>
                                        {!isSignUp && (
                            ...
                            <Button className="w-full h-14 font-black uppercase tracking-widest shadow-2xl shadow-primary/20" type="submit" disabled={isLoading}>
                                {isLoading ? "Synchronizing..." : <>{isSignUp ? <Mail className="mr-2 h-4 w-4" /> : <Lock className="mr-2 h-4 w-4" />} {isSignUp ? "Create Protocol" : "Initialize Session"}</>}
                            </Button>
                            ...
                            <p className="text-[10px] font-bold text-center text-muted-foreground uppercase tracking-widest pt-2">
                                ...
                                <button
                                    ...
                                    className="text-primary hover:opacity-70 transition-opacity underline decoration-primary/30 underline-offset-4 font-black"
                                >
                                    {isSignUp ? "Initialize Session" : "Grant Access"}
                                </button>
                            </p>
                        </CardContent>
                    </form>
